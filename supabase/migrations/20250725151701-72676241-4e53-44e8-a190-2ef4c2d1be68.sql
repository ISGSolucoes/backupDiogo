...
-- Part 1: Remove dangerous public policies
...
CREATE POLICY "Only admins can manage modules insert" 
ON public.modules FOR INSERT 
TO authenticated 
USING (is_admin(auth.uid()));

CREATE POLICY "Only admins can manage modules update" 
ON public.modules FOR UPDATE 
TO authenticated 
USING (is_admin(auth.uid()));

CREATE POLICY "Only admins can manage modules delete" 
